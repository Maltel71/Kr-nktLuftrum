...
public class BulletSystem : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        // Fixa: Förenklad kollisionskontroll
        ...
        // Fixa: När spelarens skott träffar fiend - TA BORT ljudet
        ...
        // Fixa: När fiendens skott träffar spelare - BEHÅLL ljudet här
        if (isEnemyProjectile && other.CompareTag("Player"))
        {
                ...
                !playerHealth.IsDead())
            {
                ...
                PlayHitEffect();
                audioManager?.PlayCombatSound(CombatSoundType.Hit);  // Behåll här
    ...
    //Fixa: Bättre odödlighetskontroll
    //    if (!isEnemyProjectile && other.CompareTag("Enemy"))
    //    {
    //        if (other.TryGetComponent<EnemyHealth>(out var enemyHealth))
    //        {
    ...
    //Fixa: Förbättrad spelarskadekontroll
    //    if (isEnemyProjectile && other.CompareTag("Player"))
    //    {
    //        if (other.TryGetComponent<PlaneHealthSystem>(out var playerHealth) &&
    //            !playerHealth.IsInvincible() &&
